...
let dataBuilder = () => {
  ...
  return _city.map(e => {
    ...
    // r2使用
    e.r2 = [
      {name: '<1000', value: Math.round(Math.random() * 100) + 50},
      {name: '1000-2000', value: Math.round(Math.random() * 100) + 50},
      {name: '2000-3000', value: Math.round(Math.random() * 100) + 50},
      {name: '>3000', value: Math.round(Math.random() * 100) + 50}
    ]
    // r3使用
    e.r3 = [
