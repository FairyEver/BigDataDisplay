<template>
  <layout :offset-size.sync="offsetSize">
    ...
    <template slot="r2"></template>
    <template slot="r3"></template>
...
// 数据
import c3Data from '@/data/yangZhiHuFenBu.js'
import l1Data from '@/data/paiMing-cunLan.js'
export default {
  components: {
    layout,
    l1,
